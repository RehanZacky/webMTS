                        ...
                        <div class="bg-gray-50 rounded-xl overflow-hidden flex flex-col transition-all duration-300 hover:shadow-xl hover:-translate-y-1 group">
                            <a href="berita_detail.php?id=<?= $b['id'] ?>">
                                <div class="aspect-video w-full overflow-hidden bg-gray-100">
                                    <img src="upload/gambar_berita/<?= htmlspecialchars($b['gambar_utama']) ?>" class="w-full h-full object-contain transition-transform duration-300 group-hover:scale-110" alt="Gambar: <?= htmlspecialchars($b['judul']) ?>">
                                </div>
                            </a>
