                    ...
                    while ($p = mysqli_fetch_assoc($prestasi_result)) {
                        ...
                        <div class="bg-gray-50 rounded-lg overflow-hidden flex flex-col transition-all duration-300 hover:shadow-lg hover:-translate-y-1 group">
                            <div class="aspect-video w-full overflow-hidden bg-gray-100">
                                <img src="upload/gambar_prestasi/<?= htmlspecialchars($p['gambar']) ?>" class="w-full h-full object-contain transition-transform duration-300 group-hover:scale-105" alt="Gambar: <?= htmlspecialchars($p['nama_prestasi']) ?>">
                            </div>
                            <div class="p-3 sm:p-4 md:p-5 flex flex-col flex-grow">
                                <p class="text-xs sm:text-sm font-semibold text-green-700 mb-2"><?= htmlspecialchars($p['tingkat']) ?></p>
